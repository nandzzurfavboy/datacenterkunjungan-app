            ...
            <div class="card-body">
                ...
                <form action="{{ route('profile.update') }}" method="post">
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-sm-10">
                            <input required type="number" name="nip" value="{{ auth()->user()->nip }}"
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-sm-10">
                            <input required type="text" name="jabatan" value="{{ auth()->user()->jabatan }}"
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-sm-10">
                            <select required name="gender" class="form-select form-control"
                                ...
                                <option value="0" {{ auth()->user()->gender == 0 ? 'selected' : '' }}> Laki - Laki
                                </option>
                                <option value="1" {{ auth()->user()->gender == 1 ? 'selected' : '' }}> Perempuan
                                </option>
                            </select>
                        </div>
                    </div>
