...
@section('konten')
    <div
        class="container min-h-screen px-6 flex flex-col justify-center lg:w-3/4 w-full mx-auto gap-7 lg:-mt-10 mt-4 md:-mt-0 ">
        <h1 class="mt-11 text-2xl font-bold font-inter text-slate-800 md:text-2xl lg:text-3xl">Halo Selamat Datang,</h1>
        <p class="text-base md:text-lg lg:text-xl">Anda berada di halaman Reservasi Kunjungan Data Center <span
                class="font-bold text-sky-800">DISKOMINFO PROVINSI SUMATERA UTARA</span>. Anda dapat mengajukan permohonan
            kunjungan dengan mengisi data diri pada <a href="{{ route('create') }}" class="font-bold">Form Permohonan
                Kunjungan</a>, atau mengecek status permohonan anda pada halaman <a href="{{ route('reservasi.cekstatus') }}"
                class="font-bold">Cek Status Permohonan</a>.</p>
        ...
        <div class="lg:mt-5">
            <p class="text-base md:text-lg lg:text-xl mb-5">Apabila anda mengalami kesulitan, silakan menghubungi<a
                    href="https://diskominfo.sumutprov.go.id/hubungi-kami.html" class="font-bold text-sky-800"> Pusat
                    Bantuan Dinas Komunikasi dan Informatika Provinsi Sumatera Utara</a>.</p>
        </div>
    </div>
@endsection
